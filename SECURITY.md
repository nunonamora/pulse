...
Atalaia is currently pre-1.0. Security fixes are applied to the latest release and the default branch.
...
- Atalaia runs as the current macOS user and has no privileged helper.
