...
public enum FocusPlanner {
    ...
    static func cmuxAction(for session: AgentSession) -> FocusAction? {
        ...
        tell application "cmux"
          ...
          if (count of matches) is 0 then error "Atalaia could not find a cmux terminal for this directory"
    ...
    private static func cmuxScript(surfaceID: String, tabID: String?) -> String {
        ...
        tell application "cmux"
          ...
          error "Atalaia could not find this cmux terminal"
        end tell
        """
    }
    ...
    private static func ghosttyScript(for session: AgentSession) -> String {
        ...
        if let identifier {
            ...
            tell application "Ghostty"
              ...
              if (count of matches) is not 1 then error "Atalaia could not uniquely identify the Ghostty terminal"
              focus item 1 of matches
              activate
            end tell
            """
    ...
    private static func iTermScript(identifier: String?, tty: String?) -> String {
        ...
        tell application "iTerm2"
          ...
          if matchCount is not 1 then error "Atalaia could not uniquely identify the iTerm session"
    ...
    private static func terminalScript(tty: String) -> String {
        ...
        tell application "Terminal"
          ...
          if matchCount is not 1 then error "Atalaia could not uniquely identify the Terminal tab"
