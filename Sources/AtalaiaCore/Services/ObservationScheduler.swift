...
public final class ObservationScheduler {
    ...
    public func startWithInitialReconciliation(
        ...
        workQueue.async { [weak self] in
            ...
            do {
                ...
                NSLog(
                    "Atalaia initial process reconciliation failed: %@",
    ...
    private func tick(
        ...
        do {
            ...
            NSLog("Atalaia process scan failed: %@", String(describing: error))
            return
        }
        ...
        do {
            ...
            NSLog("Atalaia state snapshot failed: %@", String(describing: error))
            return
        }
        ...
        do {
            ...
            NSLog("Atalaia reaper failed: %@", String(describing: error))
        }
        ...
        do {
            ...
            NSLog("Atalaia terminal enrichment failed: %@", String(describing: error))
        }
        refreshCodexWatcher(detected: enriched, snapshot: &snapshot)
            ...
            do {
                ...
                NSLog("Atalaia convoy suppression failed: %@", String(describing: error))
            }
    ...
    private func scanConvoyRuns(
        ...
        do {
            ...
            NSLog("Atalaia convoy watcher failed: %@", String(describing: error))
        }
        return nil
    }
    ...
    private func refreshConvoyOwnershipIndex() {
        ...
        do {
            ...
            NSLog("Atalaia Convoy ownership indexing failed: %@", String(describing: error))
        }
    ...
    private func refreshCodexWatcher(
        ...
        do {
            ...
            NSLog("Atalaia Codex watcher failed: %@", String(describing: error))
        }
    }
