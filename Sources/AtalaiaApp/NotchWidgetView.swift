    ...
    var body: some View {
        ...
        ZStack(alignment: .topLeading) {
            if !shouldHide {
                ...
                .contextMenu {
                    SettingsLink {
                        Label("Atalaia Settings", systemImage: "gearshape")
                    }
                    Divider()
                    Button {
                        NSApp.terminate(nil)
                    } label: {
                        Label("Quit Atalaia", systemImage: "power")
                    }
                }
...
/// SVG brand marks bundled in AtalaiaCore; NSImage renders SVG natively
...
private struct SettingsGearButton: View {
    ...
    var body: some View {
        ...
        .buttonStyle(.plain)
        .onHover { isHovered = $0 }
        .accessibilityLabel("Atalaia settings")
    }
}
