...
/// pacote, e o binário `pulse` que vive em `~/.pulse/bin` é uma
...
///
///     kill -USR1 $(pgrep -x Pulse)
///
/// e escreve em /tmp/pulse-shot.png.
@MainActor
enum ScreenShot {

    nonisolated static let defaultPath = "/tmp/pulse-shot.png"
